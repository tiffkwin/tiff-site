      ...
      <div className="flex items-center w-full h-full">
        <div className="flex flex-col w-full items-center">
          ...
          <div className="flex flex-row w-2/3 items-center mt-4 justify-end">
            <button title="github" className="h-8 w-8 rounded-full bg-white mx-2 hover:bg-blue-50 hover:text-" 
              // onClick={() => window.open('https://github.com/tiffkwin')}
              onClick={() => setButtonState(!isDisabled)}
            >
              <FontAwesomeIcon icon={faGithub}></FontAwesomeIcon>
            </button>
            <button title="linkedin" className="h-8 w-8 rounded-full bg-white mx-2 hover:bg-blue-50" disabled={isDisabled} onClick={() => window.open('https://www.linkedin.com/in/tiffany-k-nguyen/')}>
